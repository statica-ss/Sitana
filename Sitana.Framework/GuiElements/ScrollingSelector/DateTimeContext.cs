...
namespace Sitana.Framework.Gui
{
    public class DateTimeContext
    {
        ...
        class ElementContext : ISelectorContext
        {
            ...
            void ISelectorContext.GetData(Int32 offset, StringBuilder caption, StringBuilder annotation, out Boolean enabled)
            {
                _context.GetData(caption, annotation, offset, _type, out enabled);
            }
        ...
        private static String[] _romanMonths = new String[] { "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII" };

        public DateTimeContext(DateTime dateTime, Boolean monthsRoman, String[] daysOfWeek, String[] months)
        {
        ...
        internal void GetData(StringBuilder caption, StringBuilder annotation, Int32 offset, Type type, out Boolean enabled)
        {
            annotation.Clear();
            caption.Clear();
            ...
            switch (type)
            {
                case Type.Day:
                    ...
                    annotation.Append(_daysOfWeek[dayOfWeek]);
                ...
                case Type.Month:
                    ...
                    if (_monthsRoman)
                    {
                        caption.Append(_romanMonths[newDateTime.Month - 1]);
                    }
                    else
                    {
                        caption.AppendFormat("{0}", newDateTime.Month);
                    }

                    annotation.Append(_months[newDateTime.Month-1]);
                    break;
